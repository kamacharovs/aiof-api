    ...
    public class AiofContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserProfile>(e =>
            {
                ...
                e.Property(x => x.Gender).HasSnakeCaseColumnName().HasMaxLength(100);
                e.Property(x => x.DateOfBirth).HasSnakeCaseColumnName();
                e.Property(x => x.Age).HasSnakeCaseColumnName();
                e.Property(x => x.Occupation).HasSnakeCaseColumnName().HasMaxLength(200);
                e.Property(x => x.OccupationIndustry).HasSnakeCaseColumnName().HasMaxLength(200);
                e.Property(x => x.GrossSalary).HasSnakeCaseColumnName();
                e.Property(x => x.MaritalStatus).HasSnakeCaseColumnName().HasMaxLength(100);
                e.Property(x => x.EducationLevel).HasSnakeCaseColumnName().HasMaxLength(100);
                e.Property(x => x.ResidentialStatus).HasSnakeCaseColumnName().HasMaxLength(100);
            ...
            modelBuilder.Entity<Address>(e =>
            {
                ...
                e.Property(x => x.Id).HasSnakeCaseColumnName().ValueGeneratedOnAdd().IsRequired();
                e.Property(x => x.PublicKey).HasSnakeCaseColumnName().IsRequired();
                e.Property(x => x.StreetLine1).HasSnakeCaseColumnName().HasMaxLength(200);
                e.Property(x => x.StreetLine2).HasSnakeCaseColumnName().HasMaxLength(200);
                e.Property(x => x.City).HasSnakeCaseColumnName().HasMaxLength(200);
                e.Property(x => x.State).HasSnakeCaseColumnName().HasMaxLength(2);
                e.Property(x => x.ZipCode).HasSnakeCaseColumnName().HasMaxLength(5);
                e.Property(x => x.Country).HasSnakeCaseColumnName().HasMaxLength(200);
